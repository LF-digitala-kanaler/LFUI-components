...
const datepickerExample = () => {
  ...
  if (/Mobi/.test(navigator.userAgent)) {
    $('#datepicker-input, #datetimepicker-disabled-input, #datepicker-white-input').prop("type", "date");
  ...
  $('#datepicker, #datepicker-white-input').datetimepicker({
    locale: 'sv',
    format: 'YYYY-MM-DD',
  ...
  $('#datepicker-white').on('dp.show', function () {
    $('#datepicker-white .bootstrap-datetimepicker-widget').attr('aria-hidden', 'true');
    $('#datepicker-white button').addClass('active');
  });

  $('#datepicker-white').on('dp.hide', function () {
    $('#datepicker-white button').removeClass('active');
  });
  ...
  $('#datepicker-white').on('dp.hide', function () {
    $('#datepicker-white button').removeClass('active');
    var value = $('#datepicker-white-input').val();
    if (dateOk.test(value)) {
      $(this).find('input').addClass('form-control-valid');
      $(this).parent().addClass('has-valid');
    } else {
