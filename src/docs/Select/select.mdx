...
<Subtitle>
	The dropdown select provides the user with given options in a list which expands over the webpage
...
<Subtitle>
	To further customize the dropdown to your needs, you can use any combination of the available
	modifiers.
</Subtitle>
...
<form class="form-group">
	<div class="select" data-small-pattern="\((.+?)\)">
		<label class="select-label" for="select-secondary">
			City
		</label>
...
```html
<div class="select" data-group-toggle>...</div>
```
