...
const sliderExample = () => {
  ...
  $('#lf-slider-value').on('input', function () {
    ...
    const percent = Math.ceil(((this.value - $('#lf-slider-1').attr('min')) / ($('#lf-slider-1').attr('max') - $('#lf-slider-1').attr('min'))) * 100)
  ...
  $('#lf-slider-value-3').on('input', function () {
    ...
    const percent = Math.ceil(((this.value - $('#lf-slider-3').attr('min')) / ($('#lf-slider-3').attr('max') - $('#lf-slider-3').attr('min'))) * 100)
  ...
  $('#lf-slider-value-4').on('input', function () {
    ...
    const percent = Math.ceil(((this.value - $('#lf-slider-4').attr('min')) / ($('#lf-slider-4').attr('max') - $('#lf-slider-4').attr('min'))) * 100)
