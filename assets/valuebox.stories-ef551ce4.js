import{e as i,u as c,h as d}from"./utils-cfbb8c9c.js";const u=`<p class="text-sm mb-05 text-muted">Default</p>
<div class="row">
  <div class="col-md-4">
...
`,r=e=>{e&&i(".value-box-text",function(a){const l=a.getBBox().width||a.getComputedTextLength();a.setAttribute("viewBox",`0 0 ${l} 18`)},e)},{useEffect:v,useState:x}=__STORYBOOK_MODULE_CLIENT_API__,m={title:"Page content/Value box"},t=()=>{const[e]=x(c);return v(()=>{r(document.getElementById(e))},[]),d`
    <div id="${e}">${u}</div>
  ...
  \`;
}`,...(s=(o=t.parameters)==null?void 0:o.docs)==null?void 0:s.source}}};const p=["valueBox"];export{p as __namedExportsOrder,m as default,t as valueBox};
//# sourceMappingURL=valuebox.stories-ef551ce4.js.map
