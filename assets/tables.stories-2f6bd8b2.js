import{u as f,h as k}from"./utils-88afe92d.js";import"./hooks.module-446c997e.js";import"./jsxRuntime.module-779d8325.js";const y=`<p class="text-sm mb-05 text-muted">Default</p>
<table class="table">
  <thead>
    <tr>
...
<p class="text-sm mt-15 mb-05 text-muted">Sizing</p>
...
<p class="text-sm mt-15 mb-05 text-muted">Summary row</p>
<table class="table">
  <thead>
    <tr>
      <th scope="col">Name</th>
...
<p class="text-sm mt-15 mb-05 text-muted">Banded rows</p>
...
<p class="text-sm mt-15 mb-05 text-muted">In-table grouping</p>
<table class="table">
  <thead>
    <tr>
      <th scope="col">Name</th>
...
<p class="text-sm mt-15 mb-05 text-muted">Expandable rows</p>
...
<p class="text-sm mt-15 mb-05 text-muted">Clickable rows</p>
<table class="table table-clickable">
  <thead>
    <tr>
      <th scope="col">Name</th>
...
<p class="text-sm mt-15 mb-05 text-muted">Sorting</p>
...
`,S=`<div class="table table-comparative">
...
`,E=d=>{if(!d)return;function h(s,t,a){const c=s.tBodies[0];let l=Array.prototype.slice.call(c.rows,0);const n=document.querySelectorAll("#table-sort th");let e;for(a=-(+a||-1),l=l.sort(function(g,w){return a*g.cells[t].textContent.trim().localeCompare(w.cells[t].textContent.trim())}),e=0;e<l.length;++e)c.appendChild(l[e]);if(n[t].getAttribute("aria-sort")==="none"){for(e=0;e<n.length;e++)n[e].setAttribute("aria-sort","none");n[t].setAttribute("aria-sort","descending")}else n[t].getAttribute("aria-sort")==="descending"?n[t].setAttribute("aria-sort","ascending"):n[t].getAttribute("aria-sort")==="ascending"&&n[t].setAttribute("aria-sort","descending")}function x(s){let t=s.tHead,a;if(t&&(t=t.rows[0])&&(t=t.cells),t)a=t.length;else return;for(;--a>=0;)(function(c){let l=1;t[c].addEventListener("click",function(){h(s,c,l=1-l)})})(a)}for(const s of d.querySelectorAll("table"))x(s)},{useEffect:B,useState:A}=__STORYBOOK_MODULE_CLIENT_API__,_={title:"Page content/Tables",parameters:{backgrounds:{default:"gray"}}},r=()=>{const[d]=A(f);return B(()=>{E(document.getElementById(d))},[]),k`
    <div id="${d}">${y}</div>
  `},o=()=>S;var i,p,b;r.parameters={...r.parameters,docs:{...(i=r.parameters)==null?void 0:i.docs,source:{originalSource:`() => {
  ...
  \`;
}`,...(b=(p=r.parameters)==null?void 0:p.docs)==null?void 0:b.source}}};var m,u,v;o.parameters={...o.parameters,docs:{...(m=o.parameters)==null?void 0:m.docs,source:{originalSource:"() => Compare",...(v=(u=o.parameters)==null?void 0:u.docs)==null?void 0:v.source}}};const M=["present","compare"];export{M as __namedExportsOrder,o as compare,_ as default,r as present};
//# sourceMappingURL=tables.stories-2f6bd8b2.js.map
