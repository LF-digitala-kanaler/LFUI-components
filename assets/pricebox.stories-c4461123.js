const c={title:"Page content/Price box",parameters:{backgrounds:{default:"gray"},badges:["stable"]}};function n({footer:t}){return`
  ...
  `}function a({position:t="bottom"}){const s=`
    <div class="p-05">
  ...
  `,e='<div class="wave-pattern"></div>';return`
