const v=`<a href="#" onclick="return false" class="shortcut mb-1">
...
</div>`,f={title:"Button and links/Shortcut",parameters:{backgrounds:{default:"gray"},badges:["stable"]},args:{title:"Shortcut title"}},p=`
  <svg class="icon d-md-none" width="24" height="24">
    <use xlink:href="lf-icons/sprite/24/icons.svg#contract-24"></use>
  </svg>
  <svg class="icon d-none d-md-block" width="32" height="32">
...
`;function t({title:e,content:o,icon:d}){return`
  <a
    href="#"
  ...
  >
    ${d?p:""}
    ${o?"<div>":""}
    <strong class="shortcut-title">${e}</strong>
    ${o||""}
    ${o?"</div>":""}
  </a>
  `}function m(){return`
  ...
  `}const g=t.bind({});g.args={title:"Digital documents"};const u=t.bind({});u.args={title:"Financial Reports",icon:!0};const s={render:()=>`
    ${t({title:"Contact us",content:`
        <span class="">Open 09:00-18:00, Monday to Friday</span>
      `})}
    ${t({title:"Sustainability",content:`
      <p>
        The starting point for the sustainability efforts of Sweden’s largest
        insurance company, Länsförsäkringar, is a local and long-term
        responsibility in society. Protecting, making customers secure and helping
      ...
      `})}
  `},k=m.bind({}),w=b.bind({}),y=x.bind({}),n=()=>v;var c,i,l;s.parameters={...s.parameters,docs:{...(c=s.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: () => \`
    \${Template({
    title: 'Contact us',
    content: \`
