import{u as s}from"./utils-cfbb8c9c.js";const i={title:"Supportive microinteractions/Collapse",parameters:{badges:["stable"]},argTypes:{type:{control:"select",options:["button","a"]},background:{control:"select",options:["white","gray"]}}};function a({background:o="white",type:t="button"}){const e=s();return`
    <article>
      <${t}
        id="readMoreCollapse"
        class="btn btn-more"
