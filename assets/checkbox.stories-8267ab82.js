import{e as h,u as d,h as m}from"./utils-cfbb8c9c.js";const x=`<div class="row row-tight form-group">
...
`,k=c=>{c&&h(".checkbox-card",function(e){e.addEventListener("change",function(){this.classList.contains("active")?this.classList.remove("active"):this.classList.add("active")})},c)},v=c=>{if(!c)return;const e=c.querySelector("#checkbox-intermediate");e&&(e.indeterminate=!0)},{useEffect:b,useState:u}=__STORYBOOK_MODULE_CLIENT_API__,g={title:"Forms/Checkbox"},n=()=>{const[c]=u(d);return b(()=>v(document.getElementById(c)),[]),m`
    <div id="${c}">${p}</div>
  `},o=()=>{const[c]=u(d);return b(()=>k(document.getElementById(c)),[]),m`
    <div id="${c}">${x}</div>
  `};var s,t,l;n.parameters={...n.parameters,docs:{...(s=n.parameters)==null?void 0:s.docs,source:{originalSource:`() => {
  const [id] = useState(uid);
  useEffect(() => intermediateCheckboxExample(document.getElementById(id)), []);
  return html\`
    <div id="\${id}">\${Checkbox}</div>
  \`;
}`,...(l=(t=n.parameters)==null?void 0:t.docs)==null?void 0:l.source}}};var a,i,r;o.parameters={...o.parameters,docs:{...(a=o.parameters)==null?void 0:a.docs,source:{originalSource:`() => {
  const [id] = useState(uid);
  useEffect(() => checkboxCardExample(document.getElementById(id)), []);
  return html\`
    <div id="\${id}">\${CheckboxCards}</div>
  \`;
}`,...(r=(i=o.parameters)==null?void 0:i.docs)==null?void 0:r.source}}};const C=["checkbox","checkboxCard"];export{C as __namedExportsOrder,n as checkbox,o as checkboxCard,g as default};
//# sourceMappingURL=checkbox.stories-8267ab82.js.map
