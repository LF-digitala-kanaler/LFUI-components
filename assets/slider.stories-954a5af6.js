...
`,w=e=>{if(!e)return;const s=e.querySelector("#interval");if(s){const n=e.querySelector("#interval-low"),a=e.querySelector("#interval-high");S(s),s.addEventListener("input",function(){n.value=s.valueLow,a.value=s.valueHigh})}O(".lf-slider",function(n){n!==s&&n.addEventListener("input",function(){const a=Math.ceil((n.value-n.min)/(n.max-n.min)*100);n.style.setProperty("--progress",a);const l=document.getElementById(n.getAttribute("aria-controls"));l&&(l.value=n.value)})},e)},{useEffect:b,useState:E}=__STORYBOOK_MODULE_CLIENT_API__,B={title:"Forms/Slider"},c=()=>{const[e]=E(x);return b(()=>{w(document.getElementById(e))},[]),y`
    <div id="${e}">${_}</div>
  ...
  \`;
}`,...(h=(g=u.parameters)==null?void 0:g.docs)==null?void 0:h.source}}};const M=["value","intervall"];export{M as __namedExportsOrder,B as default,u as intervall,c as value};
//# sourceMappingURL=slider.stories-954a5af6.js.map
