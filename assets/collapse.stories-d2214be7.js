import{u as s}from"./utils-36f3a862.js";const i={title:"Supportive microinteractions/Collapse",parameters:{badges:["stable"]},argTypes:{type:{control:"select",options:["button","a"]},background:{control:"select",options:["white","gray"]}}};function a({background:o="white",type:t="button"}){const e=s();return`
    <article>
      <${t}
        id="readMoreCollapse"
        class="btn btn-more"
...
//# sourceMappingURL=collapse.stories-d2214be7.js.map
