import{e as E,u as a,h as x}from"./utils-cfbb8c9c.js";const I=`<div class="row row-tight form-group">
    ...
    <div class="checkbox-card">
      <label class="custom-control custom-checkbox">
        ...
        <span class="custom-control-label">
          <svg role="presentation" class="icon d-block mx-auto mb-05" width="40" height="40">
  ...
  <div class="col-6 col-md-3 mb-1">
    <div class="checkbox-card">
      <label class="custom-control custom-checkbox">
        ...
        <span class="custom-control-label">
          <svg role="presentation" class="icon d-block mx-auto mb-05" width="40" height="40">
            <use xlink:href="lf-icons/sprite/40/icons.svg#sustainability-40"></use>
          </svg>
          Sustainability
        </span>
      </label>
...
`,$=e=>{e&&E(".checkbox-card",function(c){c.addEventListener("change",function(){this.classList.contains("active")?this.classList.remove("active"):this.classList.add("active")})},e)},S=e=>{if(!e)return;const c=e.querySelector("#checkbox-intermediate");c&&(c.indeterminate=!0)},{useEffect:l,useState:i}=__STORYBOOK_MODULE_CLIENT_API__,D={title:"Forms/Checkboxes/Checkbox",parameters:{backgrounds:{default:"gray"},badges:["stable"]},argTypes:{}};function o({label:e,disabled:c,checked:C,indeterminate:y}){const[n]=i(a);return l(()=>{const d=document.getElementById(n);y&&d&&(d.indeterminate=!0)}),`
    <div class="custom-control custom-checkbox mr-1">
      <input
        ...
        ${c?"disabled":""}
    >
      <label class="custom-control-label" for="${n}">${e}</label>
    </div>
  `}const p=o.bind({});p.args={label:"Checkbox",checked:!1,disabled:!1,indeterminate:!1};const v=o.bind({});v.args={label:"Disabled checkbox",disabled:!0};const f=o.bind({});f.args={label:"Checked checkbox",checked:!0};const g=o.bind({});g.args={label:"Indeterminate checkbox",indeterminate:!0};const t=()=>{const[e]=i(a);return l(()=>S(document.getElementById(e)),[]),x`
    <div id="${e}">${_}</div>
  `},s=()=>{const[e]=i(a);return l(()=>$(document.getElementById(e)),[]),x`
    <div id="${e}">${I}</div>
  ...
  \`;
}`,...(m=(b=t.parameters)==null?void 0:b.docs)==null?void 0:m.source}}};var u,h,k;s.parameters={...s.parameters,docs:{...(u=s.parameters)==null?void 0:u.docs,source:{originalSource:`() => {
  const [id] = useState(uid);
  useEffect(() => checkboxCardExample(document.getElementById(id)), []);
  return html\`
    <div id="\${id}">\${CheckboxCards}</div>
  \`;
}`,...(k=(h=s.parameters)==null?void 0:h.docs)==null?void 0:k.source}}};const O=["CheckboxDefault","Disabled","Checked","Indeterminate","checkbox","checkboxCard"],w=Object.freeze(Object.defineProperty({__proto__:null,CheckboxDefault:p,Checked:f,Disabled:v,Indeterminate:g,__namedExportsOrder:O,checkbox:t,checkboxCard:s,default:D},Symbol.toStringTag,{value:"Module"}));export{w as C,v as D,g as I,p as a,f as b};
